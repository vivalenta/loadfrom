...
for($index=0; $index < $indexCount; $index++) {
	...
	print("<td>");  print(date("Y-m-d H:i:s", filemtime ($downloadDirectory.DIRECTORY_SEPARATOR.$dirArray[$index]))); print("</td>");
        print("<td>");  print(filesize_formatted(filesize($downloadDirectory.DIRECTORY_SEPARATOR.$dirArray[$index]))); print("</td>");
...
if ($trash != "1") {
	...
	print ("<a class='button' href='del.php?trash=all&file=trash'>DEL Trash</a> ");
}
echo "</html>";
